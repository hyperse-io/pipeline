...
import { Either, Left, Right } from '../src/types/types-purify-either.js';
import { Just, Nothing } from '../src/types/types-purify-maybe.js';
...
describe('Either', () => {
  ...
  test('rights', () => {
    expect(Either.rights([Right(10), Left('Error'), Right(5)])).toEqual([
      10, 5,
    ]);
  });
